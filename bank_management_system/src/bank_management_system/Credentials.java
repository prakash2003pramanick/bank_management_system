...
//		System.out.println(newString);
		...
		acc_number.setBounds(40, 150 , 160, 40);
		add(acc_number);
		...
		user_pin.setBounds(220, 300 , 500, 30);
		add(user_pin);
//checked
	...
	public void actionPerformed(ActionEvent ae) {  
		...
		try {
			...
			else
			{
				...
				String querry = "insert into "+table_name+" values ('"+formno+"','"+AccountNumber+"','"+DebitCardNumber+"','"+CreditCardNumber+"','"+user_pin+"','"+IntPass+"');";
				if(c.s != null) {
